...
#                         
          ...
          tabPanel("Hashtag Tracker",
                   sidebarPanel(
                     #numericInput("n", "#", min = 0, max = 100, value = 50),
                     textInput("hashtag_text", label = h3("Enter Hashtag Text"), value = "KPKUpdates"),
                     br(),
                     actionButton("trackButton", "Track!"),
                     p("Please do not use # with the text input")
                   ),
                   mainPanel(
